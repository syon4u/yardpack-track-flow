-- Add comprehensive test data using existing profiles and creating new customers/packages

-- Insert additional customers with various types (not linked to specific users for testing)
...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'registered', 'John Doe', 'john.doe@email.com', '+1-876-555-0003', '789 Customer Rd, Montego Bay, Jamaica', NULL, 'email', 'Regular customer, prefers email updates'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'registered', 'Jane Smith', 'jane.smith@email.com', '+1-876-555-0004', '321 Paradise Dr, Negril, Jamaica', NULL, 'sms', 'VIP customer, fast processing requested'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'registered', 'Mike Johnson', 'mike.johnson@email.com', '+1-876-555-0005', '654 Beach Blvd, Ocho Rios, Jamaica', NULL, 'email', 'Business customer, bulk packages'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'registered', 'Sarah Williams', 'sarah.williams@email.com', '+1-876-555-0006', '987 Hill View, Port Antonio, Jamaica', NULL, 'phone', 'Frequent international shopper'),
...
('p0000009-0009-0009-0009-000000000009', 'YP2024006', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'Personal Care Items', '369 Package St, Spanish Town, Jamaica', 'CVS Pharmacy', '1 CVS Dr, Woonsocket, RI', 1.2, '8x6x3 inches', 45.00, 0.15, 6.75, 6.75, 'USPS', 'USPS123456789', 'in_transit', NOW() - INTERVAL '3 days', NOW() + INTERVAL '3 days', 'Health and beauty products'),

('p0000010-0010-0010-0010-000000000010', 'YP2024007', 'gggggggg-gggg-gggg-gggg-gggggggggggg', 'Automotive Parts', '741 Visitor Rd, Mandeville, Jamaica', 'AutoZone', '123 S Front St, Memphis, TN', 12.5, '20x16x8 inches', 180.00, 0.15, 27.00, 27.00, 'UPS', 'UPS987654321', 'arrived', NOW() - INTERVAL '2 days', NOW() + INTERVAL '1 day', 'Car maintenance parts');